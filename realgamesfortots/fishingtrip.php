...
<div class="breadcrumbs">
  <div class="container">
    <header>
      <h3>Fishing Trip</h3>
      <p>- If you teach a man to fish... -</p>
    </header>
  </div>
  <!-- container ends here -->
  <hr class="separator1">
...
<div class="container">
  <section class="slider" align="middle">
    <iframe src="https://cdn.htmlgames.com/FishingTrip/
  ...
  <div class="rating">
        ...
        <div class='ratingStar'>
            <form id="rateSubmit">
                ...
                <input type="hidden" name="gameName" id="gameName" value="fishingtrip">
