            ...
            <li>
                <div style="display: flex; justify-content: center;">
                    <a href="https://card.americanexpress.com/d/american-express/?utm_mcid=3569918&utm_source=google&utm_medium=cpc&utm_term=amex&utm_cmpid=1711237649&utm_adgid=69797469267&utm_tgtid=aud-434822525019:kwd-13337556&utm_mt=e&utm_adid=344057220697&utm_dvc=c&utm_ntwk=g&utm_adpos=1t1&utm_plcmnt=&utm_locphysid=9007924&utm_locintid=&utm_feeditemid=&utm_devicemdl=&utm_plcmnttgt=&utm_programname=brandtp-cm&gclid=CjwKCAjw_YPnBRBREiwAIP6TJx78AD6fmJVJr6zWeditwzjEPUN0gpEEyxKfmTd24Nf2Uk9X3lUf2BoCduQQAvD_BwE"><img
                                src="./images/ads1.jpg" align="middle"></a></div>
            </li>
            <li>
                <div style="display: flex; justify-content: center;">
                    <a href="https://www.betonline.ag/?btag=Ll1moMBPL95xFViVLa5JkGNd7ZgqdRLk&affid=101788"><img
                                src="./images/ads2.gif" align="middle"></a>
            </li>
        </ul>
    </div>
    <!-- flexslider ends here -->
...
<div class="footer">
    <div class="container">
        ...
        <div class="one_fourth lastcolumn">
            <h3>About</h3>
            <p>Team 3 made this website to acheive a great grade. I don't even think that you will read this all. This
                is why I'm typing any words in this <a href="about.html" rel="nofollow">About</a> section</p>
        ...
        <div class="one_fourth">
            <h3>Subscription</h3>
            <p>Support us by enrolling in a subscription plan by paying a recurring monthly fee and get priority access
                to new games a week before others. <br>$ 3.99/month<br></p>
            <div class="paypal">
        ...
        <div class="one_fourth">
            <h3>Donation</h3>
            <p>Lets be charitable. Please donate so that we can fund our research on developing new and exciting games
                for all to enjoy <br>$ 5.99/once <br>
            </p>
            <div class="paypal">
                <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
                    <input type="hidden" name="cmd" value="_s-xclick"/>
...
================================================== -->
    <div id="copyright">
        <div class="container">
            <p class="copyright">&copy; Copyright 2019. &quot;Gamefortots&quot; by <a
                        href="http://www.anarieldesign.com/" rel="nofollow">Team 3</a>. All rights reserved.</p>
        </div>
        <!-- container ends here -->
    </div>
    <!-- footer ends here -->
